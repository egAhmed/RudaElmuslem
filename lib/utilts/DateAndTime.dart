...
class DateAndTime {
  static String toTimeReadable(int unix, bool is12hr) {
    ...
    var date = DateTime.fromMillisecondsSinceEpoch(unix, isUtc: false);
    //print('date' + date.toString());
    //date = date.add(const Duration(hours: 8)); //phone already formatted like this
    var formattedTime = formatToReadable.format(date);
    //print('formattedTime' + date.toString());

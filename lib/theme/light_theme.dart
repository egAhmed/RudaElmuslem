...
ThemeData lightTheme = ThemeData(
    ...
    scaffoldBackgroundColor: Color(0xffEDEFF9),//0xE4E9F1
    backgroundColor: Color(0xffEDEFF9),

    canvasColor: Color(0xffeaedf4),
    //accentColor: Colors.indigoAccent[100],
    //accentColorBrightness: Brightness.light,
    

    bottomAppBarColor:Color(0xFF6373CE),
...
//  splashFactory: # override create method from  InteractiveInkFeatureFactory
    ...
    cardTheme: CardTheme(
        // card theme
      color: Color(0x99ffffff),//0xFF3F51B5
      elevation: 0,

...
class DrawerApp extends StatefulWidget {
  ...
  static _DrawerAppState? of(BuildContext context) {
    return context.findAncestorStateOfType<State<DrawerApp>>() as _DrawerAppState?;
  }
...
class _DrawerAppState extends State<DrawerApp> with SingleTickerProviderStateMixin {
  ...
  final int _rtlSlide = DrawerApp.isRTL() ? -1 : 1;

  final bool _rtl = DrawerApp.isRTL();
  ...
  Widget build(BuildContext context) {
    final slidePercent =
        DrawerApp.isRTL() ? MediaQuery.of(context).size.width * .1 : 15.0;
